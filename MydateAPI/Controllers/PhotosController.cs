...
namespace MydateAPI.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IMyDateRepository repo, IMapper mapper,
        ...
        public async Task<IActionResult> AddPhotoForUser(int userId, [FromForm]PhotoForCreationDto photoForCreationDto)
        {
            ...
            //Check if the file is'nt empty and read the file
            if (file.Length > 0)
            {
        ...
        public async Task<IActionResult> SetMain(int userId, int id)
        {
            ...
            //Check if the id of the user match with the id of one of the photos
